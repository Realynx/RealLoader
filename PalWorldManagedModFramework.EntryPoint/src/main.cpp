...
#endif
{
    ...
    //{
        run_app_example(root_path);
    //}
    //else
    //{
        //run_component_example(root_path);
    //}
...
namespace
{
    ...
    //    load_assembly_and_get_function_pointer = host.get_dotnet_load_assembly(config_path.c_str());
