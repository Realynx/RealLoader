...
namespace RealLoaderFramework.Sdk.Services.EngineServices.Windows {
    public class WindowsEnginePattern : IEnginePattern {
        ...
        //  // 40 ? ? ? 41 ? 41 ? 41 ? 41 ? 48 81 EC 10 01 ? ? 48 8D 6C ? ? 48 89
        // https://github.com/EpicGames/UnrealEngine/blob/4.27/Engine/Source/Runtime/CoreUObject/Private/UObject/ScriptCore.cpp#L1848
        //  // 40 ? ? ? 41 ? 41 ? 41 ? 41 ? 48 81 EC F0 00 ? ? 48 8D 6C ? ? 48 89
        public string ProcessEventPattern { get; } = "40 ? ? ? 41 ? 41 ? 41 ? 41 ? 48 81 EC 10 01 ? ? 48 8D 6C ? ? 48 89";
